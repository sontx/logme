...
public final class UCEHandler {
    ...
    private static Callback<Intent> handleIntent;
    ...
    UCEHandler(Builder builder) {
        ...
        handleIntent = builder.handleIntent;
    ...
    public static class Builder {
        ...
        private Callback<Intent> handleIntent;

        public Builder(Context context) {
            this.context = context;
        }

        public Builder setHandleIntent(Callback<Intent> callback) {
            handleIntent = callback;
            return this;
        }
